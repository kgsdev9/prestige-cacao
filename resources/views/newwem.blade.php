                        ...
                        <div class="d-flex flex-column gap-5">
                            <div class="d-flex flex-row gap-2 align-items-center">
                                ...
                                <span class="text-primary fw-semibold">
                                    <span>Rejoignez l'Institut Roosevelt dès aujourd'hui</span>
                                </span>
                            </div>
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex flex-column gap-2">
                                    <h1 class="mb-0 display-2 fw-bolder">L'Établissement Supérieur de Référence</h1>
                                    <p class="mb-0">L'Institut Roosevelt offre des formations de qualité en filière BTS,
                                        adaptées pour préparer les étudiants à une carrière professionnelle réussie.</p>
                                </div>
                                <ul class="list-unstyled mb-0 d-flex flex-column gap-2">
                                    <li class="d-flex flex-row gap-2">
                                        ...
                                        <span>Programmes variés et spécialisés</span>
                                    </li>
                                    <li class="d-flex flex-row gap-2">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <span>Encadrement par des experts</span>
                                    </li>
                                    <li class="d-flex flex-row gap-2">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <div class="row gx-0 gy-4 gy-lg-0">
                            <div class="col-md-6 flex-column justify-content-start align-items-center d-none d-md-flex">
                                <div class="position-relative me-n7">
                                    <div
                                        class="position-absolute bottom-25 start-0 ms-n8 end-0 d-flex flex-column align-items-start">
                                        <div class="bg-white rounded-pill py-2 px-3 shadow mb-2 d-inline-block">
                                            ...
                                            <span class="text-dark fw-semibold">50+ Formations</span>
                                        </div>
                                        <div class="bg-white rounded-pill py-2 px-3 shadow mb-2 d-inline-block">
                                            <svg width="24" height="25" viewBox="0 0 30 31" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <span class="text-dark fw-semibold">Cours certifiés</span>
                                        </div>
                                        <div class="bg-white rounded-pill py-2 px-3 shadow">
                                            ...
                                            <span class="text-dark fw-semibold">Cours Videos</span>
                                        </div>
                                    </div>
                                    <svg width="205" height="189" viewBox="0 0 205 189" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="col-md-6 d-none d-md-block">
                                <div class="position-relative mt-5">
                                    <svg width="204" height="189" viewBox="0 0 204 189" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <div class="bg-white rounded-4 p-3 position-absolute bottom-10 start-10 mb-3 shadow">
                                        ...
                                        <div class="text-dark fw-bold fs-4">300+</div>
                                        <div class="text-gray-500">Support de cours Candidature BTS</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-10 col-md-10 col-12 mx-auto">
                        <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                            <h2 class="h1 mb-0">Explorez Nos Filières</h2>
                            <p class="mb-0 px-xl-5">Plongez dans un univers de savoir avec notre large gamme de filières
                                adaptées à vos ambitions.</p>
                        </div>
            ...
            <div class="container my-lg-8">
                <div class="row text-center mb-8">
                    <div class="col-xl-12 col-md-12">
                        <h2 class="display-4 fw-bold mb-3">Témoignages des Étudiants </h2>
                        <p class="fs-4">Voici ce que nos étudiants pensent de leur expérience à l'Institut Roosevelt et
                            dans le cadre de leur parcours académique.</p>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body p-4 p-md-8 text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                    fill="currentColor" class="bi bi-quote text-light-primary" viewBox="0 0 16 16">
                                    <path
                                ...
                                <p class="lead text-dark mt-3">
                                    "L'Institut Roosevelt m'a permis de réaliser mon rêve d'intégrer une école de renom
                                    grâce à la candidature libre."
                                </p>
                            </div>
                            <div class="card-footer bg-primary text-center border-top-0">
                                <div class="mt-n8"><img src="../../assets/images/avatar/avatar-1.jpg" alt="avatar"
                                        class="rounded-circle border-primary avatar-xl border border-4"></div>
                                <div class="mt-2 text-white">
                                    <h3 class="text-white mb-0">Jean-Marc Kouadio</h3>
                                    <p class="text-white-50 mb-1">Ancien candidat libre</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body p-4 p-md-8 text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                    fill="currentColor" class="bi bi-quote text-light-primary" viewBox="0 0 16 16">
                                    <path
                                        d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 9 7.558V11a1 1 0 0 0 1 1h2Zm-6 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0=">
                                    </path>
                                </svg>
                                <p class="lead text-dark mt-3">
                                    "Grâce à la candidature libre à l'Institut Roosevelt, j'ai trouvé ma voie et me suis
                                    épanouie dans mon programme."
                                </p>
                            </div>
                            <div class="card-footer bg-primary text-center border-top-0">
                                <div class="mt-n8"><img src="../../assets/images/avatar/avatar-2.jpg" alt="avatar"
                                        class="rounded-circle border-primary avatar-xl border border-4"></div>
                                <div class="mt-2 text-white">
                                    <h3 class="text-white mb-0">Aminata Diomandé</h3>
                                    <p class="text-white-50 mb-1">Candidat libre en commerce international</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-12 mb-4 mb-lg-0">
                        <div class="card shadow-lg">
                            <div class="card-body p-4 p-md-8 text-center">
                                ...
                                <p class="lead text-dark mt-3">
                                    "La candidature libre à l'Institut Roosevelt m'a permis d'intégrer un programme
                                    d'ingénierie prestigieux."
                                </p>
                            </div>
                            <div class="card-footer bg-primary text-center border-top-0">
                                <div class="mt-n8"><img src="../../assets/images/avatar/avatar-2.jpg" alt="avatar"
                                        class="rounded-circle border-primary avatar-xl border border-4"></div>
                                <div class="mt-2 text-white">
                                    <h3 class="text-white mb-0">Kouadio Théodore</h3>
                                    <p class="text-white-50 mb-1">Ancien candidat libre, maintenant étudiant en ingénierie
                                    </p>
                                </div>
                            </div>
                        </div>
