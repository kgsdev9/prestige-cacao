<main class="page-wrapper">
    <header data-bs-theme="dark">
      ...
      <div class="navbar navbar-expand-lg fixed-top navbar-stuck">
        <div class="container">
    ...
    <section class="container pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
      <div class="row align-items-center mt-2 pt-2 pt-sm-4 pt-lg-5">
        ...
        <div class="col-md-7 col-lg-6">
          <div class="card border-0 bg-secondary py-1 p-lg-4">
            <div class="card-body">
              ...
              ">
                <div class="swiper-wrapper" id="swiper-wrapper-57d103473bf3940c" aria-live="polite">

                  <!-- Item -->
                  <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 3" data-swiper-slide-index="0" style="width: 323px; margin-right: 30px;">
                    <p class="lead text-dark pb-3 mb-3">"Around provides us with the detailed and accurate data we need to make strategic decisions. All tools are constantly being improved and contain a lot of useful and interesting information. Thanks to Around, we can constantly analyze data quickly, efficiently."</p>
                    <div class="d-flex align-items-center">
                      <img class="rounded-circle" src="assets/img/avatar/30.jpg" width="60" alt="Jenny Wilson">
                      <div class="ps-3">
                  ...
                  <!-- Item -->
                  <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 3" data-swiper-slide-index="1" style="width: 323px; margin-right: 30px;">
                    ...
                    <div class="d-flex align-items-center">
                      <img class="rounded-circle" src="assets/img/avatar/31.jpg" width="60" alt="Esther Howard">
                      <div class="ps-3">
                  ...
                  <!-- Item -->
                  <div class="swiper-slide" role="group" aria-label="3 / 3" data-swiper-slide-index="2" style="width: 323px; margin-right: 30px;">
                    ...
                    <div class="d-flex align-items-center">
                      <img class="rounded-circle" src="assets/img/avatar/32.jpg" width="60" alt="Nick Wenirten">
                      <div class="ps-3">
          ...
          <div class="d-flex justify-content-center justify-content-md-end pt-4">
            <button class="btn btn-icon btn-sm btn-outline-primary rounded-circle me-3" type="button" id="prev-testimonial" aria-label="Previous slide" tabindex="0" aria-controls="swiper-wrapper-57d103473bf3940c">
              <i class="ai-arrow-left"></i>
            </button>
            <button class="btn btn-icon btn-sm btn-outline-primary rounded-circle" type="button" id="next-testimonial" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-57d103473bf3940c">
        ...
        <!-- CTA -->
        <div class="col-md-5 col-xl-4 offset-lg-1 pt-2 pt-md-0 mt-5 mt-md-n5">
          <div class="ps-md-4 ps-lg-0">
            <h2 class="h1 mb-4">More than 2,000 clients use Around for data analysis</h2>
            ...
            <a class="btn btn-lg btn-primary rounded-pill" href="#">Start free 14-day trial</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Benefits -->
    <section class="container pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
      <h2 class="h1 text-center pt-3 pt-sm-4 pt-lg-5 pb-3 mb-3 mb-lg-4">Our benefits</h2>
    ...
    <!-- Tools -->
    <section class="container overflow-hidden pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
      <div class="row align-items-center mt-2 pt-2 pt-sm-4 pt-lg-5">
        ...
        <div class="col-md-7 col-lg-6 offset-lg-1">
          <div class="position-relative mx-auto" style="max-width: 510px;">
            ...
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-1.png" data-aos="fade" data-aos-duration="600" data-aos-offset="250" data-aos-delay="1200" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-2.png" data-aos="fade" data-aos-duration="600" data-aos-offset="250" data-aos-delay="450" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-3.png" data-aos="fade" data-aos-duration="600" data-aos-offset="250" data-aos-delay="600" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-4.png" data-aos="fade" data-aos-duration="600" data-aos-offset="250" data-aos-delay="750" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-5.png" data-aos="fade" data-aos-duration="600" data-aos-offset="250" data-aos-delay="900" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-6.png" data-aos="fade" data-aos-duration="600" data-aos-offset="250" data-aos-delay="1050" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-7.png" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="250" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-8.png" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="250" data-aos-delay="150" alt="Icon">
            <img class="position-absolute top-0 start-0 z-2 aos-init" src="assets/img/landing/saas-2/tools/icon-9.png" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="250" data-aos-delay="300" alt="Icon">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="container py-5 my-md-3 my-lg-2 my-xl-4 my-xxl-5">
      <div class="d-md-flex align-items-center pb-3 mb-md-3 mb-lg-4 mt-2 mt-sm-3 pt-2 pt-sm-4 pt-lg-5">
        <h2 class="h1 text-center text-md-start mb-4 mb-md-0 me-md-4">Resources for you</h2>
        ...
        <ul class="nav nav-pills flex-nowrap fs-sm text-nowrap overflow-auto w-100 mx-auto me-md-0 mb-0 pb-3 pb-md-0" style="max-width: 408px;">
          <li class="nav-item mb-0">
            <a class="nav-link border" href="#">Articles</a>
          </li>
          <li class="nav-item mb-0">
            <a class="nav-link border active" href="#">Case studies</a>
          </li>
          <li class="nav-item mb-0">
            <a class="nav-link border" href="#">Tutorrials</a>
          </li>
        </ul>
      </div>
      ...
      ">
        <div class="swiper-wrapper" id="swiper-wrapper-a97c1096df76ee45c" aria-live="polite">

          <!-- Article -->
          <article class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 3" style="width: 380px; margin-right: 24px;">
            <a href="#">
              <img class="rounded-5" src="assets/img/landing/saas-2/resources/01.jpg" alt="Image">
            </a>
            <h3 class="h4 pt-4">
              <a href="#">Analytics for the HR department for the Klinos company</a>
            </h3>
            <p>Sapien ultrices egestas at faucibus eu diam velit diam id amet nibh quam rutrum fermentum diam natoque scelerisque viverra molestie fames...</p>
            <div class="d-flex flex-wrap align-items-center pt-1 mt-n2">
              ...
              <span class="fs-xs opacity-20 mt-2 mx-3">|</span>
              <a class="badge bg-primary bg-opacity-10 text-primary fs-xs mt-2" href="#">Analytics</a>
            </div>
          </article>

          <!-- Article -->
          <article class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 3" style="width: 380px; margin-right: 24px;">
            <a href="#">
              <img class="rounded-5" src="assets/img/landing/saas-2/resources/02.jpg" alt="Image">
            </a>
            <h3 class="h4 pt-4">
              <a href="#">Analytics for the Marketing department of Fast Inc.</a>
            </h3>
            <p>Morbi et massa fames ac scelerisque sit commodo dignissim faucibus vel quisque proin lectus. Laoreet sem adipiscing sollicitudin erat massa...</p>
            <div class="d-flex flex-wrap align-items-center pt-1 mt-n2">
              <a class="nav-link text-body-secondary fs-sm fw-normal p-0 mt-2 me-3" href="#">
                10
                <i class="ai-share fs-lg ms-1"></i>
          ...
          <!-- Article -->
          <article class="swiper-slide" role="group" aria-label="3 / 3" style="width: 380px; margin-right: 24px;">
            <a href="#">
              <img class="rounded-5" src="assets/img/landing/saas-2/resources/03.jpg" alt="Image">
            </a>
            <h3 class="h4 pt-4">
              <a href="#">Research data structuring and presentation in diagrams</a>
            </h3>
            <p>Egestas in neque scelerisque semper sit at eu cursus faucibus velit cras at aliquam sed dictum at at orci curabitur dictumst viverra non pharetra...</p>
            <div class="d-flex flex-wrap align-items-center pt-1 mt-n2">
              <a class="nav-link text-body-secondary fs-sm fw-normal p-0 mt-2 me-3" href="#">
                21
                <i class="ai-share fs-lg ms-1"></i>
        ...
        <!-- Pagination (bullets) -->
        <div class="swiper-pagination position-relative bottom-0 mt-2 pt-4 d-lg-none swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span></div>
      <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>

      <!-- Read more button -->
      <div class="text-center pt-4 my-2 mt-lg-0 pt-lg-5 pb-sm-2 pb-md-4">
        <a class="btn btn-outline-primary rounded-pill" href="#">Read all case studies</a>
      </div>
    </section>
    ...
    <section class="pt-2 pt-md-0">
      <div class="position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
        ...
        <div class="bg-primary position-absolute top-0 start-0 w-100 h-100 d-none d-md-block aos-init aos-animate" style="border-radius: 5rem 5rem 0 0;" data-aos="zoom-in" data-aos-duration="700" data-aos-offset="300"></div>
          ...
          <div class="row justify-content-center aos-init" data-aos="fade-up" data-aos-duration="500" data-aos-offset="300">
            <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center py-5">
              ...
              <div class="d-sm-flex justify-content-center">
                <a class="btn btn-lg btn-warning rounded-pill w-100 w-sm-auto me-sm-4 mb-3 mb-sm-0" href="#">Start free 14-day trial</a>
        ...
        <div class="position-relative z-2 px-md-5">
          <img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/saas-2/dash-light.png" width="1076" alt="Image">
          <img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/saas-2/dash-dark.png" width="1076" alt="Image">
        </div>
      </div>
    </section>
  </main>
