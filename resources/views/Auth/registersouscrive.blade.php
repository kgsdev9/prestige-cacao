...
<main class="page-wrapper">
    <div class="d-flex flex-column align-items-center position-relative h-100 px-3 pt-5">
        ...
        <!-- Home button -->
        <a class="text-nav btn btn-icon bg-light border rounded-circle position-absolute top-0 end-0 z-2 p-0 mt-3 me-3 mt-sm-4 me-sm-4"
            href="index.html" data-bs-toggle="tooltip" data-bs-placement="left" title="Back to home"
        ...
        <div class="mt-auto" style="max-width: 700px;">
            <h1 class="pt-3 pb-2 pb-lg-3">Assurance Scolaire - Myoo</h1>
            ...
            <form id="multiStepForm" method="POST" enctype="multipart/form-data">
                ...
                <div id="step2" style="display: none;">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" class="form-control" id="piece_identite" name="piece_identite" accept="image/*" required>
                    </div>
                    <div class="mb-4">
...
<script>
    ...
    document.getElementById('nextStep1').addEventListener('click', function() {
        ...
        if (document.getElementById('nom').value && document.getElementById('prenom').value && document.getElementById('email').value && document.getElementById('telephone').value) {
