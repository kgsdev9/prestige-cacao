        ...
        <div class="mt-auto" style="max-width: 700px;">
            ...
            <form id="multiStepForm" method="POST" enctype="multipart/form-data">
                ...
                <div x-show="step === 4" style="display: none;">
                    ...
                    <div class="mb-4">
                        <p>Avant de finaliser votre inscription à l'assurance scolaire, vous devez accepter les conditions d'utilisation de Moyo Assurance.</p>
                        <textarea readonly rows="5" class="form-control" style="resize: none;">Les conditions d'utilisation de Moyo Assurance...</textarea>
                    </div>
                    <div class="form-check mb-4">
                        <input class="form-check-input" type="checkbox" id="acceptConditions" x-model="formData.acceptConditions">
                        <label class="form-check-label" for="acceptConditions">J'accepte les conditions d'utilisation</label>
                    </div>
                    <button type="button" class="btn btn-secondary" @click="previousStep()">Précédent</button>
