    ...
    <div class="container mb-4">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <a href="#!">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_8175_5853" x1="12"
                                            y1="4" x2="12" y2="20"
                        ...
                        <div class="slider dashboard-slider">
                            ...
                            <div>
                                <div class="row align-items-center gy-5">
                                    <div class="col-xl-6 col-12">
                                        <div class="d-flex flex-column gap-4">
                                            <div class="d-flex flex-column gap-2">
                                                ...
                                                <p class="mb-0">Earn industry-recognized certifications by
                                                    passing the required exams that include questions reflecting
                                                    real world problems faced in a job.</p>
                                            </div>
                                            <div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="text-center d-xl-block d-none">
                                            <img src="https://geeksui.codescandy.com/geeks/assets/images/svg/certificates.svg"
                                                alt="certificates" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="row align-items-center gy-5">
                                    <div class="col-xl-6 col-12">
                                        <div class="d-flex flex-column gap-4">
                                            <div class="d-flex flex-column gap-2">
                                                ...
                                                <p class="mb-0">Engage with real-world challenges using our
                                                    projects directory. Apply your knowledge to real scenarios in a
                                                    practical environment.</p>
                                            </div>
                                            <div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="text-center d-xl-block d-none">
                                            <img src="https://geeksui.codescandy.com/geeks/assets/images/svg/projects.svg"
                                                alt="projects" />
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <!-- Card -->
                <div class="card">
                    <a href="#"><img src="../assets/images/course/course-html.jpg" alt="course"
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        ...
                        <div>
                            <span
                                class="badge bg-success-subtle border border-success rounded-pill text-success">Completed</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        ...
                        <div>
                            <span
                                class="badge bg-warning-subtle border border-warning rounded-pill text-warning">In
                                Process</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <!-- Card -->
                <div class="card">
                    <a href="#"><img src="../assets/images/course/course-python.jpg" alt="course"
                            class="card-img-top" /></a>
                    <!-- Card body -->
                    <div class="card-body d-flex flex-column gap-3">
                        ...
                        <div>
                            <span class="badge bg-light-subtle border rounded-pill text-secondary">Not
                                Started</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <!-- Card -->
                <div class="card">
                    <a href="#"><img src="../assets/images/course/course-react.jpg" alt="course"
                            class="card-img-top" /></a>
                    <!-- Card body -->
                    <div class="card-body d-flex flex-column gap-3">
            ...
            <div class="col-12">
                <div class="border-dashed py-6 text-center rounded-3 px-4 px-md-7 px-lg-0">
                    ...
                    <div class="d-flex flex-column gap-2 mb-4">
                        ...
                        <p class="mb-0">Improve your chances of getting hired with an industry recognized Geeks
                            Certification.</p>
                    </div>
                    <div>
